"""
@file: env.py
@description: Конфигурация окружения Alembic для миграций БД
...
# env.py находится в backend/alembic/env.py, поэтому нужно подняться на 3 уровня вверх
project_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__))))
sys.path.insert(0, project_root)

# Импортируем Base и все модели
from src.backend.db.session import Base, SQLALCHEMY_DATABASE_URL
...
from src.backend.models.table import TableORM
from src.backend.models.session import SessionORM
...
# Устанавливаем URL БД из переменных окружения или используем значение по умолчанию
